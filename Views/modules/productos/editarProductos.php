<?php  
 ...
 $consulta = $conexion->conectar()->prepare("SELECT * FROM productos pro JOIN categorias cat ON cat.idcategoria = pro.idcategoria WHERE idproducto = :idproducto");
    ...
    <input type="hidden" name="idproducto" value="<?php echo $key['idproducto']; ?>">
      ...
      <select class="form-control chosen-select" id="idcategoria" name="idcategoria">     
           <option value="<?php echo $key['idcategoria'] ?>" ><?php echo ucwords($key['nombrecategoria']) ?>
              ...
              <?php   
             $consulta = $conexion->conectar()->prepare("SELECT * FROM categorias "); ?>
          ...
          <div class="row">
            ...
            <?php    $consulta = $conexion->conectar()->prepare("SELECT * FROM usuarios "); ?>
            <?php foreach ($consulta as $key ): ?>
