...
<nav class="navbar navbar-dark bg-warning">
  ...
  <div class="collapse navbar-toggleable-md" id="navbarResponsive">
    <a class="navbar-brand" href="index"><i class="fa fa-calendar" aria-haspopup="true" aria-expanded="true"></i> Reservas</a>
    <ul class="nav navbar-nav">
      <li class="nav-item dropdown nav-item active">
        <a class="nav-link dropdown-toggle" href="#" id="responsiveNavbarDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
          <i class="fa fa-product-hunt" aria-hidden="true"></i> Gestión de Productos</a>
      ...
      <li class="nav-item dropdown nav-item active">
        <a class="nav-link dropdown-toggle" href="#" id="responsiveNavbarDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"><i class="fa fa-universal-access" aria-hidden="true"></i> Gestión de Categorías</a>
        ...
        <div class="dropdown-menu" id="sub" aria-labelledby="responsiveNavbarDropdown">
          ...
          <a id="sub" class="dropdown-item" href="ventasDiarias"><i class="btn btn-danger btn-sm  fa fa-usd"></i>Gestión de Reportes</a>
       ...
       <li class="nav-item dropdown  nav-item active float-xs-right">
         <a class="nav-link dropdown-toggle" href="#" id="responsiveNavbarDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user-circle" aria-hidden="true"></i> Hola! <?php echo  ' ' .strtoupper($_SESSION[ 'nombreusuario']); ?></a>
         <div class="dropdown-menu" aria-labelledby="responsiveNavbarDropdown">
          <a class="dropdown-item" href="salir"><i class="btn btn-danger btn-sm fa fa-window-close-o"> </i> Cerrar Sesión</a>
          <a class="dropdown-item" href="usuarios"><i class="btn btn-primary btn-sm fa fa-address-book"></i> Gestion de Usuarios</a>
        </div>
      </li>
    </ul>
  </div>
...
<nav class="navbar navbar-dark bg-warning">
  ...
  <div class="collapse navbar-toggleable-md" id="navbarResponsive">
    <a class="navbar-brand" href="index"><i class="fa fa-calendar" aria-hidden="true"></i> Reservas</a>
    <ul class="nav navbar-nav">
      <li class="nav-item dropdown nav-item active">
